## プロフィール
- 名前：上原 佑太
- 所属：株式会社ユーザーローカル(2025年4月 ~ )
## 学位論文
-  深層強化学習とVAEによる次元削減を用いた自転運転シミュレーター上での運転行動学習 (学士)
-  運転行動学習でのSENetを組み込んだVAEの次元削減効果（修士）
## 研究業績
- Y. Uehara and S. Matsumae: Enhancing Dimensionality Reduction in Driving Behavior Learning: Integrating SENet with VAE, International Journal of Networking and Computing, Vol.15, No.2, pp.138-152 (July 2025)
